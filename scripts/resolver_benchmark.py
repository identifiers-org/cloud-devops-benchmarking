...
def present_response_times_stats(response_times_dataset):
    ...
    logger.info("Mode: {:.2f}".format(response_times_dataset.get_response_time_mode()[1]))
    logger.info("Median response time: {:.2f}".format(response_times_dataset.get_response_time_median()))
    logger.info("----------------------------")
